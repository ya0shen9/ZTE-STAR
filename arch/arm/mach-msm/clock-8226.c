...
static struct clk_freq_tbl ftbl_gcc_blsp1_uart1_6_apps_clk[] = {
	...
	F_GCC(  16384000,      gpll0,    15, 256,   625),//add by wangtao for es705
	F_GCC(  19200000,         xo,   1,    0,    0),
	F_GCC(  24000000,      gpll0,   5,    1,    5),
	F_GCC(  32000000,      gpll0,   1,    4,   75),
	F_GCC(  32768000,      gpll0,    1,   512, 9375),//add by wangtao for es705
...
static struct clk_lookup msm_clocks_8226[] = {
	...
	CLK_LOOKUP("ref_clk",   cxo_d1.c, "spi4.1"),
	...
	/*ZTE_MODIFY add blsp1 uart5 for communicating with es705 by wangtao,2013.12.12*/
	...
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "78.qcom,camera"),///chengjia added for ap1302
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "79.qcom,camera"),///chengjia added for ap1302
	...
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "78.qcom,camera"),//chengjia added for ap1302
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "79.qcom,camera"),//chengjia added for ap1302
	...
	CLK_LOOKUP("osr_clk2", div_clk2.c, "es705-codec-gen0"),

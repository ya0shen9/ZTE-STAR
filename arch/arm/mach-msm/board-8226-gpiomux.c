...
static struct gpiomux_setting ir_reset_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};
#ifdef CONFIG_PROJECT_P898S10_ZTE
static struct gpiomux_setting ir_power_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting gpio_spi_lattice_config = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting gpio_spi_cs_lattice_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct gpiomux_setting gpio_uart_lattice_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
//chengjia modified for led gpio
#if 0
...
//chengjia modified for flash gpio
	#if 0
	{
...

  {
		.gpio = 27,
		.settings = {
			[GPIOMUX_ACTIVE] = &ir_reset_cfg,
			[GPIOMUX_SUSPENDED] = &ir_reset_cfg,
		},
	},
#ifdef CONFIG_PROJECT_P898S10_ZTE	
	{
		.gpio = 51,
		.settings = {
			[GPIOMUX_ACTIVE] = &ir_power_cfg,
			[GPIOMUX_SUSPENDED] = &ir_power_cfg,
		},
	},
	{
		.gpio = 66,
  ...
  {					/*  UART   */
		.gpio      = 5,		/* BLSP2 UART1 RX*/
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_uart_lattice_config,
			[GPIOMUX_SUSPENDED] = &gpio_uart_lattice_config,
		},
	},
	{					/*  UART   */
		.gpio      = 4,		/* BLSP2 UART1 TX */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_uart_lattice_config,
			[GPIOMUX_SUSPENDED] = &gpio_uart_lattice_config,
		},
	...
	{					/*  SPI   */
		...
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_spi_lattice_config,
			[GPIOMUX_SUSPENDED] = &gpio_spi_lattice_config,
		},
	},
	{					/*  SPI   */
	...
	{					/*  SPI   */
		.gpio      = 14,		/* BLSP1 QUP4 SPI_CS_N */
		.settings = {
			[GPIOMUX_ACTIVE] = &gpio_spi_cs_lattice_config,
			[GPIOMUX_SUSPENDED] = &gpio_spi_cs_lattice_config,
		},
	},
	{					/*  SPI   */
...
//chengjia added for ap1302 and flash 2014/02/15
	{
		.gpio = 32, /* ISP_1V2_EN */
		.settings = {
			[GPIOMUX_ACTIVE]    = &cam_settings[3],
...
static struct gpiomux_setting tert_mi2s_out_act_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH
...
static struct msm_gpiomux_config msm8226_tert_mi2s_configs[] __initdata = {
	...
	.settings = {
		[GPIOMUX_SUSPENDED] = &tert_mi2s_sus_cfg,
		[GPIOMUX_ACTIVE] = &tert_mi2s_out_act_cfg,
		},
	},

	{
	.gpio = 51,    /* qua mi2s out */
	.settings = {
		[GPIOMUX_SUSPENDED] = &tert_mi2s_sus_cfg,
		[GPIOMUX_ACTIVE] = &tert_mi2s_out_act_cfg,
		},
...
//chengjia modified for ap1302 and flash 2014/02/15
	/*{
		.gpio = 63,
		.settings = {
...
#ifndef CONFIG_PROJECT_P898S10_ZTE
	{
		.gpio = 66,
		.settings = {
			[GPIOMUX_SUSPENDED] = &auxpcm_sus_cfg,
...
#ifdef CONFIG_PROJECT_P898S10_ZTE
/* ZTE_MODIFY by wangtao begin add for es705 reset/wakeup */
static struct gpiomux_setting es705_pin = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
...
#if 1
static struct gpiomux_setting es705_uart_pin = {
	.func = GPIOMUX_FUNC_2,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
};
...
static struct gpiomux_setting es705_int_pin = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm_es705_config[] __initdata = {
#if 1
	{
		.gpio	= 20,		/* ES705 uart_in/wakeup */
		.settings = {
		    [GPIOMUX_ACTIVE] = &es705_uart_pin,
			[GPIOMUX_SUSPENDED] = &es705_uart_pin,
		},
	},
	{
		.gpio	= 21,		/* ES705 uart_out */
		.settings = {
		    [GPIOMUX_ACTIVE] = &es705_uart_pin,
			[GPIOMUX_SUSPENDED] = &es705_uart_pin,
		},
...
#else
	{
		.gpio	= 20,		/* ES705 uart_in/wakeup */
		.settings = {
		    [GPIOMUX_ACTIVE] = &es705_pin,
			[GPIOMUX_SUSPENDED] = &es705_pin,
		},
	},
#endif	
	{
	...
	},
	{
		.gpio	= 52,		/* ES705 int */
		.settings = {
			[GPIOMUX_ACTIVE] = &es705_int_pin,
			[GPIOMUX_SUSPENDED] = &es705_int_pin,
				
		},
	},	
};
/* ZTE_MODIFY by wangtao end */	
#endif
...
#ifdef CONFIG_PROJECT_P898S10_ZTE
	msm_gpiomux_install(msm_es705_config, ARRAY_SIZE(msm_es705_config));
#endif
	/*

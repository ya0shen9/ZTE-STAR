...
#define GES_NOACTION_MASK 	(0x80)
#define GES_SPEED_MASK			(0x60)
#define GES_MOTION_MASK		(0x1f)

#define GES_NOACTION_ENABLE 	(1<<7)
#define GES_SPEED_FAST			(3<<5)
#define GES_SPEED_MID			(2<<5)
#define GES_SPEED_SLOW			(1<<5)

#define TMG_MODE_TOUCH 			1
#define TMG_MODE_MUSIC 			2
#define TMG_MODE_KEY				3
#define TMG_MODE_LOCK				4
#define TMG_MODE_OTHER_APP		5
#define TMG_MODE_GAME 			6
#define TMG_MODE_BOOK 			7
...
struct tmg399x_chip {
	...
	struct tmg_lux_segment *segment;
	int segment_num;
	int seg_num_max;
	bool als_gain_auto;
	u8 prox_th_factor;
...
extern u8 work_mode;
extern int ges_motion;
extern bool ges_touch_style;
extern bool ges_dir8_enable;
extern char enter_zoom;

extern void tmg399x_ges_work_mode(struct tmg399x_chip *chip,u8 mode,u8 ges_state);
extern void tmg3993_gesture_zoom(int p_data);

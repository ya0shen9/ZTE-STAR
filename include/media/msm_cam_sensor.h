...
enum msm_sensor_power_seq_gpio_t {
	...
	SENSOR_GPIO_VDIG,
	SENSOR_GPIO_VAF,
	SENSOR_GPIO_CTRDVDD, /* added begin for rear camera imx135 by chengjia 2013-12-18 */
	SENSOR_GPIO_ISP_XVDD,//chengjia added for ap1302
	SENSOR_GPIO_ISP_IOVDD,//chengjia added for ap1302
//chengjia add for flash gpio
	SENSOR_GPIO_FLASH_HWEN_892,
	SENSOR_GPIO_FLASH_HWEN_898,
	SENSOR_GPIO_FLASH_INT_898,
//chengji add end
	SENSOR_GPIO_ISP_IOVDD_HMISC,//ZTE_MODIFY by zhangxiaobo to use new power control for new 898S10 board 2014-03-11
	SENSOR_GPIO_MAX,
};
...
enum msm_sensor_cfg_type_t {
	...
	// zte_modify added by jidewei 2014-02-18 for ap1302 begin
	CFG_SET_BRIGHTNESS, 
	CFG_SET_AEC_ALGO_TYPE, 	
	CFG_SET_AUTOFLASH, 
	CFG_GET_FLASH_STATE,    // jidewei 2014-02-21
	CFG_SET_AP1302_CAPTURE,    // jidewei 2014-02-27
	CFG_SET_ZSL_MODE,    // jidewei 2014-02-28
	// zte_modify added by jidewei 2014-02-18 for ap1302 end
	CFG_SET_AFAREA,         //zte_modify:add by zhanggduo 20140225
	CFG_GET_AF_FOCUS_DATA,  //zte_modify:add by zhanggduo 20140225
	CFG_SET_AF_MODE,        //zte_modify:add by zhangduo 20140226
	CFG_SET_MANUAL_AWB,    // jidewei 2014-03-06
	CFG_SET_AEC_AREA,      //zte modify:add by zhangduo 20140307
	CFG_SET_MANUAL_FOCUS, //zte_modify:add by zhangduo 20140312
	//zte_modify added by wangzhengwei 2014-03-25 for ap1302 AE begin
	CFG_GET_ZTE_AP1302_AE,
	//zte_modify added by wangzhengwei 2014-03-25 for ap1302 AE end
	CFG_SET_AEC_LOCK,//zte_modified chengjia added for ae lock 2014-07-02
};

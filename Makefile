...
#-----------------------------------------------------------------------------
vendor_remove_dirs := app priv-app preload
...
#-----------------------------------------------------------------------------
vendor_saved_apps := AntHalService Bluetooth BluetoothExt \
	CABLService CellBroadcastReceiver ChinaWeatherTV_M2001 CMCC_DM \
	com.qualcomm.location com.qualcomm.services.location \
	Contacts_OEM_Module Contacts_Patch DiskCleanup EMode EModeExt fastdormancy \
	Galaxy4 GsmTuneAway HoloSpiralWallpaper HomeSwitcher \
	HPLegacyPlugin-release ims InterfacePermissions KeyChain LatinIME LinkZone \
	LiveWallpapers LiveWallpapersPicker MagicSmokeWallpapers MFinancePRC-Bold \
	Mi-EasyAccess Mi-SystemUISetting Mi_GestureBuilder MiFriendsHub.apk MIPop \
	MYuenPRC-SemiBold NoiseField PhaseBeam PhotoTable PowerSaveMode Protips \
	QComQMIPermissions SearchWidget Soudunlock \
	Stk SVIService VisualizationWallpapers VocalPrint WeatherClockHF WfdService \
	WiFiShare xtra_t_app zdmDaemon zgesture ZteLBSApp \
	ZteSnsShare.apk \
	AliveUpdate BrowserProvider \
	MusicFX PhotoEditor ProxyHandler \
	VoiceAssistant ZDMV3NJ ZtePkgUsageStats

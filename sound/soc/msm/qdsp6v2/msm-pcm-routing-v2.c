...
static const struct snd_kcontrol_new tertiary_mi2s_rx_mixer_controls[] = {
	...
	MSM_FRONTEND_DAI_MULTIMEDIA4, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),//add by shengguanghui
	SOC_SINGLE_EXT("MultiMedia5", MSM_BACKEND_DAI_TERTIARY_MI2S_RX,
	MSM_FRONTEND_DAI_MULTIMEDIA5, 1, 0, msm_routing_get_audio_mixer,
	msm_routing_put_audio_mixer),
};

/* ZTE_modify modify FM audio driver for P862A10 begin */
static const struct snd_kcontrol_new tertiary_mi2s_hl_mixer_controls[] = {
	SOC_SINGLE_EXT("INTERNAL_FM_TX", MSM_BACKEND_DAI_TERTIARY_MI2S_RX,
	MSM_BACKEND_DAI_INT_FM_TX, 1, 0, msm_routing_get_port_mixer,
	msm_routing_put_port_mixer),
};
/* ZTE_modify modify FM audio driver for P862A10 end */
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	*/
	...
	SND_SOC_DAPM_AIF_IN("SLIMBUS_3_TX", "Slimbus3 Capture", 0, 0, 0, 0),
		...
		0, 0, 0, 0),
        SND_SOC_DAPM_AIF_IN("TERT_MI2S_UL_HL", "TERT_MI2S_HOSTLESS Capture",
		0, 0, 0, 0),
	SND_SOC_DAPM_SWITCH("FM_MI2S_DL_HL", SND_SOC_NOPM, 0, 0,
	...
	SND_SOC_DAPM_MIXER("TERT_MI2S_RX Port Mixer", SND_SOC_NOPM, 0, 0,
			   tertiary_mi2s_hl_mixer_controls,
			   ARRAY_SIZE(tertiary_mi2s_hl_mixer_controls)),
	/* ZTE_modify modify FM audio driver for P862A10 end */		   
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"TERT_MI2S_RX Audio Mixer", "MultiMedia5", "MM_DL5"},//add by shengguanghui
	...
	{"FM_MI2S_DL_HL", "Switch", "TERT_MI2S_DL_HL"},
        {"TERT_MI2S_RX", NULL, "FM_MI2S_DL_HL"},
        {"TERT_MI2S_RX", NULL, "TERT_MI2S_RX Port Mixer"},
	/* ZTE_modify modify FM audio driver for P862A10 end */

...
static struct escore_api_access es705_api_access[ES705_API_ADDR_MAX] = {
	...
	[ES705_VOICE_SENSE_DETECTION_SENSITIVITY] = {
		.read_msg = { ES705_API_WORD(ES705_GET_ALGO_PARAM, 0x5008) },
		.read_msg_len = 4,
		.write_msg = { ES705_API_WORD(ES705_SET_ALGO_PARAM_ID, 0x5008),
			       ES705_API_WORD(ES705_SET_ALGO_PARAM, 0x0000) },
		.write_msg_len = 8,
		.val_shift = 0,
		.val_max = 10,
	...
	[ES705_VOICE_SENSE_USER_DETECTION_SENSITIVITY] = {
		.read_msg = { ES705_API_WORD(ES705_GET_ALGO_PARAM, 0x5009) },
		.read_msg_len = 4,
		.write_msg = { ES705_API_WORD(ES705_SET_ALGO_PARAM_ID, 0x5009),
			       ES705_API_WORD(ES705_SET_ALGO_PARAM, 0x0000) },
		.write_msg_len = 8,
		.val_shift = 0,
		.val_max = 10,

...
#define ZTE_CODE_CHANGE 
#define WCD_9306_CODEC
#define USING_1M_STREAMING//Richard 4.23
...
enum {
	...
	ES705_CVS_PRESET,
	ES705_RX_ENABLE,
	ES705_VOICE_SENSE_USER_DETECTION_SENSITIVITY,
	ES705_API_ADDR_MAX,
};
...
struct es705_priv {
	...
	struct mutex overall_mutex; /*by Richard to add mutex for all of control and sysfs, except for some special ones, like abort*/
	int vs_abort_kw;
	int pm_state;
	...
	u16 preset_bothlink_array[ES705_PRESET_ARRAY_SIZE];
	...
	int slim_log;
	int non_vs_data_access;/*Richard 3.29*/
};

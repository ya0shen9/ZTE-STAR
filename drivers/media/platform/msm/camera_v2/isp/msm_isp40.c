...
/*chengjia added for isp patch 2014-03-17*/
#include <asm/div64.h>
#include "msm_isp40.h"
				...
				enum msm_isp_reset_type reset_type)
{
	...
	return wait_for_completion_interruptible_timeout(
		&vfe_dev->reset_complete, msecs_to_jiffies(1000));////50 modified by chengjia 20140421 for  qcomm patch
}
...
/** ZTE_MODIFY chengjia modified isp patch 2014-03-17*/
		/*	delta =
...
{
	struct msm_vfe_axi_shared_data *axi_data = &vfe_dev->axi_data;
	/*modified by chengjia for isp patch 2014-03-17*/

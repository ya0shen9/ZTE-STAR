...
/* ZTE_MODIFY by zhangxiaobo for adding font camera proc info 2014-02-20
 */
...
/** ZTE_MODIFY by zhangxiaobo for commenting useless VDIG 2014-01-28 */
#if 0
	{
...
static int ov5648_read_proc_info(char *page, char ** start, off_t offset,
	int count, int *eof, void * data)
{
	*eof = 1;
	return sprintf(page, "ID: 0x5648\n" "Name: ov5648\n");
}

static int create_proc_camera_entity(void)
{
	if (create_proc_read_entry("front_camera_info", 0, NULL,
	  	      ov5648_read_proc_info, NULL) == NULL) {

		...
		int count, int *eof, void *data)
{
    ...
    rc = qpnp_vadc_read(vadc_tmp, P_MUX7_1_1, &result);
    if (rc) {
        pr_err("VADC read error with %d\n", rc);
        return 0;
    }
#if defined(CONFIG_PROJECT_P862A10_ZTE)
    /* (3.9k/(100k+3.9k))*1.8v = 0.067564v, +-0.02v */
    if(result.physical > 47000 && result.physical < 88000){
        snprintf(page ,5,"BOM1\n");
        len = 5;
    }
    else if(result.physical > 143000 && result.physical < 184000){
        snprintf(page ,5,"BOM2\n");
        len = 5;
    }
    else if(result.physical > 225000 && result.physical < 265000){
        snprintf(page ,5,"BOM3\n");
        len = 5;
    }
    else if(result.physical > 338000 && result.physical < 379000){
        snprintf(page ,5,"BOM4\n");
        len = 5;
    }
    else if(result.physical > 428000 && result.physical < 469000){
        snprintf(page ,5,"BOM5\n");
        len = 5;
    }
	else if(result.physical > 559000 && result.physical < 600000){
        snprintf(page ,5,"BOM6\n");
        len = 5;
    }
	else if(result.physical > 627000 && result.physical < 668000){
        snprintf(page ,5,"BOM7\n");
        len = 5;
    }
	else if(result.physical > 709000 && result.physical < 750000){
        snprintf(page ,5,"BOM8\n");
        len = 5;
    }
	else if(result.physical > 790000 && result.physical < 831000){
        snprintf(page ,5,"BOM9\n");
        len = 5;
    }
	else if(result.physical > 961000 && result.physical < 1002000){
...
#elif defined(CONFIG_PROJECT_P898S10_ZTE)
    /* (3.9k/(100k+3.9k))*1.8v = 0.067564v, +-0.02v */
    if(result.physical > 47000 && result.physical < 88000){
        snprintf(page ,6,"BOM-B\n");
        bom_id = 'B';
        len = 6;
    }
    /*else if(result.physical > 143000 && result.physical < 184000){ 
        bom C is spetial, for R311=499K, R310=39K, result.physical is about 1670000v  */
    else if(result.physical > 1650000 && result.physical < 1690000){
        snprintf(page ,6,"BOM-C\n");
        bom_id = 'C';
        len = 6;
    }
    else if(result.physical > 225000 && result.physical < 265000){
        snprintf(page ,6,"BOM-D\n");
        bom_id = 'D';
        len = 6;
    }
    else if(result.physical > 338000 && result.physical < 379000){
        snprintf(page ,6,"BOM-E\n");
        bom_id = 'E';
        len = 6;
    }
    else if(result.physical > 428000 && result.physical < 469000){
        snprintf(page ,6,"BOM-F\n");
        bom_id = 'F';
        len = 6;
    }
    else if(result.physical > 559000 && result.physical < 600000){
        snprintf(page ,6,"BOM-G\n");
        bom_id = 'G';
        len = 6;
    }
    else if(result.physical > 627000 && result.physical < 668000){
        snprintf(page ,6,"BOM-H\n");
        bom_id = 'H';
        len = 6;
    }
    else if(result.physical > 709000 && result.physical < 750000){
        snprintf(page ,6,"BOM-I\n");
        bom_id = 'I';
        len = 6;
    }
    else if(result.physical > 790000 && result.physical < 831000){
        snprintf(page ,6,"BOM-J\n");
        bom_id = 'J';
        len = 6;
    }
    else if(result.physical > 961000 && result.physical < 1002000){
        snprintf(page ,6,"BOM-K\n");
        bom_id = 'K';
        len = 6;
    }
    else if(result.physical > 1059000 && result.physical < 1100000){
        snprintf(page ,6,"BOM-L\n");
        bom_id = 'L';
        len = 6;
    }
    else if(result.physical > 1136000 && result.physical < 1177000){
        snprintf(page ,6,"BOM-M\n");
        bom_id = 'M';
        len = 6;
    }
    else if(result.physical > 1219000 && result.physical < 1259000){
        snprintf(page ,6,"BOM-N\n");
        bom_id = 'N';
        len = 6;
    }
    else if(result.physical > 1388000 && result.physical < 1428000){
        snprintf(page ,6,"BOM-O\n");
        bom_id = 'O';
        len = 6;
    }
    else{
    ...
    /* (100k/(100k+5.1k))*1.8v = 1.712655v, +-0.02v, 1690000~1740000uV*/
    if(result.physical > 1690000 && result.physical < 1740000){
        snprintf(page ,6,"BOM-B\n");
        bom_id = 'B';
        len = 6;
    }
    else if(result.physical > 1580000 && result.physical < 1630000){
        snprintf(page ,6,"BOM-C\n");
        bom_id = 'C';
        len = 6;
    }
    else if(result.physical > 1480000 && result.physical < 1520000){
        snprintf(page ,6,"BOM-D\n");
        bom_id = 'D';
        len = 6;
    }
    else if(result.physical > 1390000 && result.physical < 1440000){
        snprintf(page ,6,"BOM-E\n");
        bom_id = 'E';
        len = 6;
    }
    else if(result.physical > 1330000 && result.physical < 1380000){
        snprintf(page ,6,"BOM-F\n");
        bom_id = 'F';
        len = 6;
    }
    else if(result.physical > 1100000 && result.physical < 1150000){
        snprintf(page ,6,"BOM-G\n");
        bom_id = 'G';
        len = 6;
    }
    else if(result.physical > 1050000 && result.physical < 1100000){
        snprintf(page ,6,"BOM-H\n");
        bom_id = 'H';
        len = 6;
    }
    else if(result.physical > 950000 && result.physical < 1000000){
        snprintf(page ,6,"BOM-I\n");
        bom_id = 'I';
        len = 6;
    }
    else if(result.physical > 880000 && result.physical < 930000){
        snprintf(page ,6,"BOM-J\n");
        bom_id = 'J';
        len = 6;
    }
    else if(result.physical > 770000 && result.physical < 820000){
        snprintf(page ,6,"BOM-K\n");
        bom_id = 'K';
        len = 6;
    }
    else if(result.physical > 630000 && result.physical < 680000){
        snprintf(page ,6,"BOM-L\n");
        bom_id = 'L';
        len = 6;
    }
    else if(result.physical > 580000 && result.physical < 630000){
        snprintf(page ,6,"BOM-M\n");
        bom_id = 'M';
        len = 6;
    }
    else if(result.physical > 370000 && result.physical < 420000){
        snprintf(page ,6,"BOM-N\n");
        bom_id = 'N';
        len = 6;
    }
    else if(result.physical > 280000 && result.physical < 330000){
        snprintf(page ,6,"BOM-O\n");
        bom_id = 'O';
        len = 6;
    }
...
char zte_get_bom_id(void)
{
    ...
    zte_read_hver_material(page, start, off, count, eof, data);
    return bom_id;
}
EXPORT_SYMBOL(zte_get_bom_id);

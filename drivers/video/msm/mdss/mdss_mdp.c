...
static int mdss_mdp_parse_dt_misc(struct platform_device *pdev)
{
	...
	mdata->ab_factor.numer = 28;
	mdata->ab_factor.denom = 20;
	pr_info("lipeng mdss_mdp_parse_dt_misc ab_factor %d %d\n", mdata->ab_factor.numer, mdata->ab_factor.denom);
#endif
	/*
	...
	mdss_mdp_parse_dt_fudge_factors(pdev, "qcom,mdss-ib-factor",
		&mdata->ib_factor);
#if defined CONFIG_PROJECT_P892S10_ZTE
	mdata->ib_factor.numer = 28;
	mdata->ib_factor.denom = 10;
	pr_info("lipeng mdss_mdp_parse_dt_misc ib_factor %d %d\n", mdata->ib_factor.numer, mdata->ib_factor.denom);
#endif

...
$(call add-clean-step, find $(OUT_DIR) -name "lights.msm8226*" -print0 | xargs -0 rm -f)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/s2002/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/s2002/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/s2002/recovery/root/default.prop)
